...
public class TiDBDialect extends MySQLDialect {
	...
	private DatabaseVersion TiDBVersion;
		...
		if ( versionStringTiDB != null ) {
			...
			if ( components.length >= 7 ) {
				try {
					...
					TiDBVersion = DatabaseVersion.make( majorVersion, minorVersion, patchLevel );
				}
	...
	public DatabaseVersion getTiDBVersion() {
		return TiDBVersion;
	}
	...
	public boolean supportsCascadeDelete() {
		...
		return getTiDBVersion().isSameOrAfter( 6, 6 );
	}
